    ...
    public class OwnerController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteOwner(Guid id)
        {
            try
            {
                ...
                {
                    _logger.LogError($"Cannot delete owner with id: {id}. It has related accounts. Please delete accounts first.");
                    return BadRequest($"Cannot delete owner with id: {id}. It has related accounts. Please delete accounts first.");
                }
